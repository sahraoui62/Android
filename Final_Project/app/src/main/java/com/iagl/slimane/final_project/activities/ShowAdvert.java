...
public class ShowAdvert extends Activity {
            ...
            listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, final View view,
                    ...
                    try {
                        ...
                        /*dialog.setPositiveButton("Itinéraire", new DialogInterface.OnClickListener(){
                            public void onClick(DialogInterface dialog, int which) {
                                // implémenter la google map avec itinéraire géoloc + lieu de départ de la transaction
                            }
                        });*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add_advert) {
            Intent intent = new Intent(ShowAdvert.this, ProposeTransaction.class);
            startActivity(intent);
        }
        if (id == R.id.action_show_advert) {
            Intent intent = new Intent(ShowAdvert.this, ShowAdvert.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.action_signup) {
            Intent intent = new Intent(ShowAdvert.this, SignUp.class);
            startActivity(intent);
        }
        if (id == R.id.action_home) {
            Intent intent = new Intent(ShowAdvert.this, Home.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.action_show_my_advert) {
            Intent intent = new Intent(ShowAdvert.this, ShowMyAdvert.class);
            startActivity(intent);
        }
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_show_advert).setVisible(false);
        return true;
    }
}

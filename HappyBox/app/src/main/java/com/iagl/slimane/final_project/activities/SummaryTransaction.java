...
public class SummaryTransaction extends Activity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_signin) {
            Intent intent = new Intent(SummaryTransaction.this, SignIn.class);
            startActivity(intent);
        }
        if (id == R.id.action_signup) {
            Intent intent = new Intent(SummaryTransaction.this, SignUp.class);
            startActivity(intent);
        }
        ...
        if (id == R.id.action_show_my_advert) {
            Intent intent = new Intent(SummaryTransaction.this, ShowMyAdvert.class);
            startActivity(intent);
        }
